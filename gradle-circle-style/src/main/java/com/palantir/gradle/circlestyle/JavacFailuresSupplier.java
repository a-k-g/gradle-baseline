...
public final class JavacFailuresSupplier implements FailuresSupplier {
    ...
    public static JavacFailuresSupplier create(final JavaCompile javac) {
        ...
        ((LoggingManager) javac.getLogging()).addStandardErrorListener(errorStream::append);
    ...
    @Override
    public RuntimeException handleInternalFailure(File reportDir, RuntimeException ex) {
        return ex;
    }
}
